...
export default function AboutPage(){
    ...
    return <section className='sm:pt-10'>
        ...
        <p className='mt-8 text-center bg-green-50 w-max mx-auto px-4 py-2 rounded-full border border-green-100 font-inter text-[13px] font-medium text-slate-800'>Know Your Partner</p>
            <p className={`text-center w-[60%] mx-auto ${dynamicWidth} font-poppins font-bold text-[40px] sm:w-[80%] sm:text-[18px]`}>Empowering <span className='text-[midnightblue]'>Businesses</span> Through Innovation and Technology</p>
        ...
        <div className='flex justify-center space-x-6 sm:flex-col'>
            <div className='w-[40%] sm:w-[90%] sm:mx-auto'>
            ...
            <div className='flex flex-col mt-12 w-[40%] sm:w-[90%] sm:mx-auto'>
        ...
        <div className='flex justify-center space-x-6 sm:mt-8 sm:flex-col'>
            <div className='flex flex-col mt-12 w-[40%] sm:w-[90%] sm:mx-auto sm:hidden'>
                <BiSolidQuoteAltLeft className="text-green-800 ml-1 mb-4"/>
                <hr className='w-[20%] mb-8 border-2 border-green-600 ml-2'/>
                <div className='flex'>
                    {/* <RiDoubleQuotesL/> */}
        ...
        <div className='flex justify-center space-x-6 bg-gradient-to-b from-white to-slate-200 sm:mt-8 sm:flex-col sm:pb-20'>
            <div className='w-[40%] mb-20 sm:w-[90%] sm:mx-auto sm:mb-4'>
            ...
            <div className='flex flex-col mt-20 sm:mt-2 w-[40%] sm:w-[90%] sm:mx-auto'>
                <BiSolidQuoteAltLeft className="text-green-800 ml-1 mb-4"/>
                <hr className='w-[20%] mb-8 border-2 border-green-600 ml-2'/>
                <div className='flex'>
                    {/* <RiDoubleQuotesL/> */}

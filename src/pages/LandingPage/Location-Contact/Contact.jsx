...
export default function Contacts(){
    return <section className="w-[50%] flex flex-col items-center sm:w-[90%] sm:mb-6">
        <div>
            ...
            <p className="font-inter text-slate-600 text-[13px] text-center sm:w-[90%] mx-auto">Ready to help your company scale faster? Let&apos;s chat about we can help.</p>
        </div>
        ...
        <div className="flex flex-col items-start mt-6 w-[80%]">
            ...
            <p className="text-[13px] font-inter text-slate-600 leading-6">Want to visit our office? We’d love to meet you! Whether it’s for a project discussion, partnership opportunities, or just a friendly chat about tech, our doors are open.</p>

...
export default function WhyChooseUs(){
    return <section>
        ...
        <div className="flex justify-center space-x-10 mb-10">
            <div className="w-[27%] border-r p-4 ">
            ...
            <div className="w-[27%] border-r p-4">
                ...
                <p className="font-inter text-[13px] text-slate-600 mt-2 italic h-[20vh]">We understand that every business is unique. That’s why we customize every project to fit your exact needs, ensuring that the final product is aligned with your goals, industry standards, and customer expectations.</p>
                <button className="mt-4 border border-blue-800 px-4 py-2 text-blue-800 rounded-full">
                    <BsArrowRight className="text-blue-800"/>
                </button>
            </div>
            <div className="w-[27%] p-4 ">
                ...
                <p className="font-inter font-bold mb-4 text-slate-800">Client-Centric Approach</p>
                <p className="font-inter text-[13px] text-slate-600 mt-2 italic h-[20vh]">At CodeWorks, our success is measured by your success. We work closely with you to understand your goals and create solutions that drive measurable results. Our transparent communication ensures you are always in control.~</p>
                <button className="mt-4 border border-blue-800 px-4 py-2 text-blue-800 rounded-full">
                    <BsArrowRight className="text-blue-800"/>
                </button>
            </div>

...
export default function WorkingProcess(){
    return <section className="py-16">
        ...
        <div className="flex justify-center space-x-10 sm:space-x-4 sm:flex-col">
            <div className="w-[40%] sm:w-[90%] sm:mx-auto p-4 border border-blue-800 bg-gradient-to-b from-blue-50 rounded-lg h-[37vh]">
            ...
            <div className="w-[40%] sm:w-[90%] sm:mx-auto p-4 border rounded-lg mt-20 sm:mt-10">
        ...
        <div className="flex justify-center space-x-10 sm:mt-6 sm:flex-col sm:space-x-4">
            <div className="w-[40%] sm:w-[90%] sm:mx-auto p-4 border rounded-lg h-[40vh]">
            ...
            <div className="w-[40%] sm:w-[90%] sm:mx-auto sm:mt-6 p-4 border border-blue-800 bg-gradient-to-b from-blue-50 rounded-lg mt-20">
        ...
        <div className="flex justify-center space-x-10 mt-10 sm:mt-4 sm:space-x-6 sm:flex-col">
            ...
            <div className="w-[40%] sm:w-[90%] sm:mx-auto sm:mt-10 p-4 border rounded-lg mt-20">
        ...
        <div className="ml-28 sm:ml-2 sm:mt-4">
            <div className="w-[40%] sm:w-[90%] sm:mx-auto p-4 border border-blue-800 bg-gradient-to-b from-blue-50 rounded-lg h-[40vh]">

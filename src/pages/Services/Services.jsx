    ...
    return <section id="services" className="">
        ...
        <div className='flex justify-center mt-16 mb-20 space-x-10'>
            ...
            <div className='w-[30%] mx-auto flex justify-center items-center'>
                <img src={phone} alt='pic' className='h-[70vh]'/>
            </div>
        </div>

        <div className='flex justify-center mt-16 mb-20 space-x-10'>
            <div className='w-[40%]'>
                <img src={web} alt='pic' className='w-[100%] border rounded-lg mt-6'/>
            </div>
            <div className='mt-8 w-[40%]'>
        ...
        <div className='flex justify-center mt-16 mb-20 space-x-16'>
            ...
            <div className='w-[45%] mx-auto flex justify-center items-center'>
                <img src={dashboard} alt='pic' className='h-[70vh] border rounded-lg mt-8'/>
            </div>
        </div>

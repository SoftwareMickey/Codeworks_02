...
export default function NewsLetter(){
    ...
    return <section className="py-16 bg-gradient-to-b from-white to-slate-200 w-full">
        <div className="flex justify-between w-[90%] mx-auto mb-6 sm:flex-col">
            <div>
            ...
            <div className="flex sm:flex-col">
                <div className="flex border bg-slate-100  border-slate-300 rounded-full h-max sm:w-[80%] sm:mb-4 sm:mx-auto">
                ...
                <div className="ml-4 sm:mx-auto sm:w-[80%]">
                    {/* <button className="bg-[#6cc727] px-4 py-2 rounded-full text-white font-inter text-[13px]">Subscribe</button> */}
                    <button className="bg-[midnightblue] px-4 py-2 rounded-full text-white font-inter text-[13px] sm:w-full">Subscribe</button>
                </div>
            </div>
        </div>
